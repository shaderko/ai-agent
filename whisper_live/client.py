...
class Client:
    ...
    def _handle_timeout(self):
        """Called when no new segments are received within the timeout duration."""
        if self.msg_callback:
            self.msg_callback(self.transcript[-1]['text'])
...
class TranscriptionClient(TranscriptionTeeClient):
    ...
    def __init__(
        ...
        self.client = Client(
            ...
            max_connection_time=max_connection_time, msg_callback=msg_callback
        )
